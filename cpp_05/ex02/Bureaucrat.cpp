...
void	Bureaucrat::signForm(AForm &form)
{
	try
	{
		...
		std::cout<<this->getName()<<" signed form "<< form.AForm::get_name()<<std::endl;
	}
	catch (std::exception &err)
	{
		std::cerr<<this->Bureaucrat::getName()<<" couldn't sign "
		<<form.AForm::get_name()<<" because "
		<<err.what()<<std::endl;
	}
}
...
void	Bureaucrat::executeForm(AForm &form)
{
	...
	{
		form.execute(*this);
		std::cout<<this->getName()<<" executed form "<< form.AForm::get_name()<<std::endl;
	}
	catch (std::exception &err)
	{
		std::cerr<<this->Bureaucrat::getName()<<" couldn't execute "
		<<form.AForm::get_name()<<" because "
		<<err.what()<<std::endl;
	}
}
